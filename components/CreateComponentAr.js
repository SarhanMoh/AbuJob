    ...
    return (
      <SafeAreaView style={styles.containerBig}>
        ...
        >
          ...
          <Text style={styles.textInfo}>الاسم الكامل</Text>
          <TextInput
          ...
          <Text style={styles.textInfo}> المهنة / الخدمة المقدمة</Text>
          <TextInput
            placeholder={"المهنة / الخدمة المقدمة"}
            placeholderTextColor="#899499"
          ...
          <TextInput
            ...
            maxLength={11}
          />
          <Text style={styles.textInfo}>المحتوى</Text>
          <TextInput
            placeholder={"المحتوى"}
            placeholderTextColor="#899499"
            ...
            textAlign="right"
          />
          <Text style={styles.textInfo}>التقييم</Text>
          <TextInput
            placeholder={"التقييم"}
            placeholderTextColor="#899499"
