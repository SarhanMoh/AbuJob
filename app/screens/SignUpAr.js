        ...
        .catch((error) => {
          ...
          switch (error.code) {
            ...
            case "auth/wrong-password":
              alert("غير صحيح", "خطأ في البريد الالكتروني أو كلمة المرور", [{ text: "جيد" }]);
              break;
          ...
          >
              ...
              <Text style={styles.text}>
               <Text>بالانضمام, فإنك تؤكد موافقتك على</Text>
                <Text style={styles.link}> تعليمات الاستخدام |</Text> 
                <Text style={styles.link}>سياسةالخصوصية </Text>
                <Text textAlign="right">الخاصة بنا</Text>
              </Text>
              <TouchableOpacity onPress={() => navigation.navigate("FirstPageAr")}>
                <Text style={styles.buttonSignIn}>هل لديك حساب؟ تسجيل الدحول</Text>
              </TouchableOpacity>
            </View>
          </KeyboardAvoidingView>
        </ScrollView>
