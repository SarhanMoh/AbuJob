...
export default function RatingPageAr({ route, navigation }) {
    ...
    <SafeAreaView style={styles.containerBig}>
      ...
      >
        <View style={styles.container}>
          ...
          >
            <Text style={styles.text}>الكفاءة</Text>
            <AirbnbRating
              count={5}
              showRating={false}
              defaultRating={0}
            ...
            />
            <Text style={styles.text}>سهولة الوصول</Text>
            <AirbnbRating
              count={5}
              showRating={false}
              defaultRating={0}
              ...
              style={styles.rateButton}
            />
            <Text style={styles.text}>السرعة</Text>
            <AirbnbRating
              count={5}
              showRating={false}
              defaultRating={0}
              ...
              style={styles.rateButton}
            />
            <Text style={styles.text}>تقييم الأسعار</Text>
            <AirbnbRating
              count={5}
              showRating={false}
              defaultRating={0}
              ...
              style={styles.rateButton}
            />
            <Text style={styles.text}>الطلاقة باللغة</Text>
            <AirbnbRating
              count={5}
              showRating={false}
              defaultRating={0}
            ...
            <View style={styles.commentCon}>
              <TextInput
                ...
                fontSize="18"
                placeholder="أضف تعليقا ... (اختياري)"
