...
class BusinessRegisterAr extends Component {
  constructor() {
    super();
  ...
  addRequests() {
    ...
    if (this.state.name === "") {
      ...
      alert("يرجى تسجيل رقم عمل معتمد ");
    } else if (this.state.ownerName === "") {
      alert("يرجى تسجيل اسم صاحب العمل ");
    } else if (this.state.languages === "") {
      alert("يرجى ادخال اللغات ");
    } else if (this.state.email === "") {
      alert("يرجى تسجيل البريد الإلكتروني  ");
    } else if (this.state.address === "") {
      alert("يرجى تسجيل العنوان ");
    } else if (this.state.phone_number === "") {
      alert("يرجى تسجيل رقم الهاتف ");
    } else if (this.state.city === "") {
      alert("يرجى تسجيل المدينة");
    } else {
      this.setState({
        isLoading: true,
      });     
      ...
      >
        <KeyboardAvoidingView style={styles.container} behavior="padding">
          ...
          <View style={styles.inputContainer}> 
            <Text style={styles.textInfo}>اسم العمل</Text>
            <TextInput
              ...
              style={styles.input}
            />
            <Text style={styles.textInfo}>رقم العمل المعتمد </Text>
            <TextInput
              placeholder='رقم العمل المعتمد'
              placeholderTextColor="#899499"
              ...
              style={styles.input}
            />
            <Text style={styles.textInfo}>اسم صاحب العمل</Text>
            <TextInput
              ...
              style={styles.input}
            />
              <Text style={styles.textInfo}>اللغات</Text>
            <TextInput
              placeholder='اللغات'
              placeholderTextColor="#899499"
            ...
            <TextInput
              ...
              style={styles.input}
            />
            <Text style={styles.textInfo}>العنوان</Text>
            <TextInput
              placeholder='العنوان'
              placeholderTextColor="#899499"
            ...
            <TextInput
              ...
              style={styles.input}
            />
            <Text style={styles.textInfo}>المدينة</Text>
            <TextInput
              placeholder='المدينة'
              placeholderTextColor="#899499"
              textAlign= "right"
...
export default BusinessRegisterAr;